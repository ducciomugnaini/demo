...
public class RunHeuristics {
	...
	public static void main(String[] args) throws Exception{
        ...
        File dirEntrada = new File("C:\\Documents and Settings\\Eunice Lopez\\My Documents\\workspace\\HyperHeuristics\\tables\\");
        // Path where all instances in .txt are:
        File dirEntradaPart = new File("C:\\Documents and Settings\\Eunice Lopez\\My Documents\\workspace\\HyperHeuristics\\instances\\");
        // The aggregated results will fall here:
        File dirSalida = new File("C:\\Documents and Settings\\Eunice Lopez\\My Documents\\workspace\\HyperHeuristics\\results\\",trainingSet);
        // The single instances results will fall here:
        File dirSalidaPart = new File("C:\\Documents and Settings\\Eunice Lopez\\My Documents\\workspace\\HyperHeuristics\\results\\individualResults");
 
        int numHeuristics = 6;  //Number of heuristics to solve the set of instances
        boolean repetition = true;   // true= solve again and over write results files
	...
	public static void run(File directorioEntrada, File directorioSalidaGral, File directorioSalida, File archivoProblemas, String archivo, int numHeuristicas, boolean repeticion, boolean graficar) throws Exception{
